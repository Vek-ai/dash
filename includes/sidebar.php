            ...
            <div id="tree-wrap">
                <div class="side-bar">
                    ...
                    <ul class="topnav menu-left-nest">
                        ...
                        <li>
                            <a class="tooltip-tip ajax-load" href="manage_drones.php" title="Manage Drones">
                                <i class="fontawesome-th-list"></i>
                                <span>Manage Drones</span>
                            </a>
                        </li>

                        <li>
                            <a class="tooltip-tip ajax-load" href="manage_airports.php" title="Manage Airports">
                                <i class="fontawesome-plane"></i>
                                <span>Manage Airports</span>
                            </a>
                        </li>

                        <li>
                            <a class="tooltip-tip ajax-load" href="manage_flight_plan.php" title="Manage Flight Plan">
